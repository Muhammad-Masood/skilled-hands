...
import QuarterBox from "@/components/ui/box";
...
export default function Home() {
  ...
  return (
    <div className="">
      <div className="mt-8 mx-10 flex flex-col items-center">
        ...
        <ul>
          ...
          <div className=" text-slate-600">{`ID: ${review.id}`}</div>
          <div className=" text-slate-600">{`Rating: ${review.rating}`}</div>
          </div>  
          ))}
        </ul>
      </div> 
